...
public class OneUserDetailsService implements UserDetailsService {
    ...
    OneUserDetailsService(PessoaRepository repository) {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        Pessoa usuario = this.repository.findByCpf(username)
        ...
        // Ele define o que o usuário pode fazer no sistema (ex: ROLE_ADMIN, ROLE_USER,
        // PODE_DELETAR)
        return new org.springframework.security.core.userdetails.User(usuario.getCpf(), usuario.getSenha(),
                new ArrayList<>());
        // return new
        // org.springframework.secutiry.core.userdetails.Pessoa(usuario.getNome(),
        // usuario.getCpf(), new ArrayList<>());
    }
